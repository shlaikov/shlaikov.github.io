(function(t) {
    ...
    let s = function(s, e) {
        ...
        this.strPos = 0, this.arrayPos = 0, this.stopNum = 0,
    ...
    s.prototype = {
        ...
        build: function() {
            ...
            if(this.showCursor === !0 && (this.cursor = t('<span class="typed-cursor">' + this.cursorChar + "</span>"), this.el.after(this.cursor)), this.stringsElement) {
                ...
                let e = this.stringsElement.children();
        ...
        typewrite: function(t, s) {
            ...
            if(this.stop !== !0) {
                let e = Math.round(70 * Math.random()) + this.typeSpeed,
                i = this;
        ...
        backspace: function(t, s) {
            ...
            if(this.stop !== 0) {
                let e = Math.round(70 * Math.random()) + this.backSpeed,
                    i = this;
                i.timeout = setTimeout(function() {

                    if("html" === i.contentType && ">" === t.substr(s).charAt(0)) {

                        for(let e = ""; "<" !== t.substr(s - 1).charAt(0) && (e -= t.substr(s).charAt(0), s--, (0 > s));) {
                                s--, e += "<";
                        }
                    }
                    let r = t.substr(0, s);
                    i.attr ? i.el.attr(i.attr, r) : i.isInput ? i.el.val(r) : "html" === i.contentType ? i.el.html(r) : i.el.text(r),
                    s > i.stopNum ? (s--, i.backspace(t, s)) : s <= i.stopNum && (i.arrayPos++, i.arrayPos === i.strings.length ? (i.arrayPos = 0, i.shuffle && (i.sequence = i.shuffleArray(i.sequence)),
